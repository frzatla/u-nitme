...
sitemap, scrapes each AOS page, and saves all results to final_aos.json.
...
def main():
    ...
    parser.add_argument("--output", "-o", default="final_aos.json",
                        help="Output JSON filename (default: final_aos.json)")
